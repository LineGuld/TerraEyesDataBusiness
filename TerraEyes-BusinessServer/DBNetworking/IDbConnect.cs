...
namespace TerraEyes_BusinessServer.DBNetworking
{
    public interface IDbConnect
    {
        ...
        Task<List<CarbondioxideMeasurement>> GetCarbonMearsurementsFromDb(string userId);
        ...
        Task<List<CarbondioxideMeasurement>> GetTerrariumCarbonMearsurementsFromDb(string userId, string terrariumId);
    }
}